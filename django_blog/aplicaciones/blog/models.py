...
from django_ckeditor_5.fields import CKEditor5Field # <-- NUEVA IMPORTACIÓN

class Categoria(models.Model):
    id = models.AutoField(primary_key = True)
    nombre = models.CharField('Nombre de Categoría', max_length = 100, null = False, blank = False)
    estado = models.BooleanField('Categoría Activate/Categoría no Activada',default = True)
...
class Post(models.Model):
    ...
    class Meta:
        ...
        # Añade esta línea para ordenar por fecha de creación (más reciente primero)
